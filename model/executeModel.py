...
tv = TfidfVectorizer(decode_error="replace",ngram_range=(1,2),stop_words=stop_words,vocabulary=pickle.load(open("model/feature.pkl", "rb")))
res_feature = tv.fit_transform([Total])
logreg = joblib.load('model/final_1Model.sav')
